...
2. Exploring a Dataset
   The module explains how to examine a dataset by checking its structure, attributes (features), data types, and general characteristics. This is done using basic exploratory techniques with Pandas.
3. Python Packages for Data Analysis
   I was introduced to several important Python libraries widely used in data science, including:
   - Pandas — for data manipulation and analysis
   - NumPy — for numeric and array operations
   - Matplotlib / Seaborn — for data visualization
   These packages form the core toolkit for performing analysis in Python.
4. Importing and Exporting Data
   I learned how to load data from various file formats such as CSV and Excel, and how to export processed data back to files. Functions commonly used include:
   - pd.read_csv()
   - df.to_csv()
   - pd.read_excel()
5. Obtaining Basic Insights
   The module covers simple but essential techniques to gain initial insights from data, such as:
   - Displaying the first few rows using df.head()
   - Checking data types with df.dtypes
   - Getting descriptive statistics with df.describe()
